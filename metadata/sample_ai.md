...
![Google Docs screenshot showing an AI sheet containing templated text.](/gql/assets/sampleAI.png)

This is how your AI could look once you have run the script.

[An AI Sheet populated using GraphQL](/gql/assets/sampleAI.pdf)
